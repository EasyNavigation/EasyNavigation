...
/// \file
/// \brief Implementation of CollisionChecker.
  ...
  const std::string & param_prefix)
{
  ...
  node->get_parameter(param_prefix + ".robot_height", robot_height_);
...
bool
CollisionChecker::check(NavState & nav_state)
{
  EASYNAV_TRACE_EVENT;
  bool imminent = false;
...
void
CollisionChecker::publish_collision_zone_marker(
